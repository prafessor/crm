...
export default function LogoUploader({
  ...
  return (
    <div className={clsx('flex mb-3', !square && 'gap-10', square && 'gap-2 flex-col')}>
      ...
      <label
        htmlFor={id}
        className={clsx('flex flex-col items-center justify-center h-40 bg-white border border-slate-900 border-dashed cursor-pointer', !square && 'w-40 rounded-full', square && 'w-full')}
      >
        <Image
          className="mb-1"
          width={48}
